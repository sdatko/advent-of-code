...
#
# At first glance, they seem like normal stones: they're arranged in
# a perfectly straight line, and each stone has a number engraved on it.
#
...
# --- Solution ---
#
# We start by reading the input file into a list of stones, by splitting data
# over white characters (spaces) and mapping to integers. Then we perform
# a loop that implements the blinking – in each iteration we process all
# current stones and perform action depending on the stone value: replace 0
# with 1, split the even number into two smaller ones or replace X with 2024*X.
# Finally, after the given number of iterations (blinks), we return the current
# number of stones as an answer.
#
