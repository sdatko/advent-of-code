...
# --- Solution ---
#
# The difference in this part is that instead of counting just unique variants
# of (start, goal) pairs, we count all possible paths variants that eventually
# lead from any start to any goal. So, just a change of 2 lines was needed
# in the original code to find an answer.
#
