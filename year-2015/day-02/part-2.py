...
# --- Solution ---
#
# The difference here is that we need to calculate the length instead of area.
# The length is a sum of two components: smallest face perimeter and some value
# which is equal to the volume of the cube. We find the smallest face through
# selection of smallest sum of sides. Finally we print the total length.
#
...
def main():
    ...
    for box in boxes:
        perimeter = 2 * min(box[0] + box[1], box[1] + box[2], box[0] + box[2])
