...
# --- Solution ---
#
# We start by reading the input into a list of lists of numbers, by splitting
# the file over newlines and then each line over spaces with mapping of result
# to the integers. Then in a loop we process every row (list of numbers),
# finding the smallest and the largest number in that row and calculating
# the difference between them. Finally, as an answer, we return the sum of all
# differences found.
#
