...
# Add these numbers together to get 70. Then, store this value at the output
...
# just before the last computer caught fire. To do this, before running
...
# --- Solution ---
#
# We start by reading the input into a list of numbers, splitting the file
# over commas and casting to the integers. Then we execute the program,
# starting from position 0, until we reach the exit instruction (opcode 99).
# We also implement actions that are given in the description (for opcodes
# 1 and 2). Finally, as an answer, we return the current value present
# at position 0 of the program after the processing.
#
