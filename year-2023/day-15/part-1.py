...
# and then further into the facility. At one point, you pass a button with
# a faint snout mark and the label "PUSH FOR HELP". No wonder you were loaded
...
# from outside. As you admire the large assortment of lenses available
# to further focus the light, the reindeer brings you a book titled
...
# when parsing the initialization sequence. To verify that your HASH algorithm
# is working, the book offers the sum of the result of running the HASH
...
# --- Solution ---
#
# We start by reading the input file into a list of strings to process
# by splitting the input over commas. Then for each string from given list
# we calculate the HASH value, using a helper function, that gets the ASCII
# number for each character, then multiply the result by 17 and gets the rest
# of division by 256. Finally, after obtaining values for all input strings,
# we return the sum of calculated values as an answer.
#
