...
# --- Solution ---
#
# We start by reading the input into a list of strings (lines) to process.
# For each line, we filter out all non-numeric characters, leaving the list
# of remaining digits only. Then we calculate the calibration value by joining
# the first and last digit. Finally we return the sum of all calculated values.
#
