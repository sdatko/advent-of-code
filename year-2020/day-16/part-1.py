...
# the first number is always the same specific field, the second number
# is always a different specific field, and so on - you just don't know
...
# tickets contain values that are not valid for any field. In this example,
# the values on the first nearby ticket are all valid for at least one field.
# This is not true of the other three nearby tickets: the values 4, 55,
# and 12 are are not valid for any field. Adding together all of the invalid
