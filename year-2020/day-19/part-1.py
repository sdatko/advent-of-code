...
# monster! Unfortunately, the connection to the satellite is having problems,
...
# must match rule 1 followed by rule 3 or it must match rule 3 followed
# by rule 1.
#
...
# (For example, aaaabbb might appear to match rule 0 above, but it has
# an extra unmatched b on the end.)
#
