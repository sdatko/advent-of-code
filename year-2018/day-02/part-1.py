...
# take forever to search the warehouse for two similar box IDs..."
# They walk too far away to hear any more.
#
# Late at night, you sneak to the warehouse - who knows what kinds of paradoxes
# you could cause if you were discovered - and use your fancy wrist device
# to quickly scan every box and produce a list of the likely candidates
# (your puzzle input).
#
...
# --- Solution ---
#
# We start by reading the input into a list of strings by splitting the file
# over newline characters. Then we browse each of the strings to figure out
# how many of them have duplicated letters or three occurrences of any letter.
# We do not care about the exact numbers of duplicates, e.g. if there is `a`
# and `b` duplicated in a given string, we only need to know if there are any
# letters repeated two or three times there. For this, we count occurrences
# for each letter and note if there repetitions. Finally, as an answer here,
# we print the multiplication of number of strings that have duplicates and
# number of strings that have three repetitions of any letter.
#
