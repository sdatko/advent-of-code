...
# at the Temporal Anomaly Research and Detection Instrument Station
# tells you. She sounded pretty worried when she called you down here.
# "At 500-year intervals into the past, someone has been changing
# Santa's history!"
#
# "The good news is that the changes won't propagate to our time stream
# for another 25 days, and we have a device" - she attaches something
# to your wrist - "that will let you fix the changes with no such propagation
...
# at the device's tiny screen. "Error: Device must be calibrated before
...
# --- Solution ---
#
# We start by reading the file into a list of numbers by splitting the file
# over newlines and casting each line into an integer. Then we calculate
# the final frequency, which is basically a sum of the changes (individual
# values from the input file).
# As an answer we simply return the calculated sum.
#
...
def main():
    ...
    final_frequency = starting_frequency + sum(changes)
