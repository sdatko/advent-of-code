...
# --- Solution ---
#
# The difference in this second part is that we need to find a common element
# not within halves of each rucksack, but by processing rucksacks in groups
# of three. With Python's magic, this is actually easier to write in code
# than the first part ;-)
#
...
def main():
    ...
    for rucksack1, rucksack2, rucksack3 in zip(rucksacks[0::3],
                                               rucksacks[1::3],
                                               rucksacks[2::3]):
        common_item = set(rucksack1) & set(rucksack2) & set(rucksack3)
