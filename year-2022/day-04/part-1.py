...
# --- Solution ---
#
# We read the input file line-by-line, splitting every line to a tuple
# of 4 values: the beginning and the end of first range, as well as the start
# and the end of second range (so, in short: x1 x2 y1 y2). Then, all we need
# is to check whether both x1 and x2 lie between y1 and y2 (and vice versa).
# For the answer, we count how many of such overlaps occur.
#
