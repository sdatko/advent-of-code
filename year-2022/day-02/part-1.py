...
# Paper, or Scissors using a hand shape. Then, a winner for that round
# is selected: Rock defeats Scissors, Scissors defeats Paper, and Paper
# defeats Rock. If both players choose the same shape, the round instead
# ends in a draw.
#
...
# for a single round is the score for the shape you selected (1 for Rock,
# 2 for Paper, and 3 for Scissors) plus the score for the outcome of the round
...
# --- Solution ---
#
# We start with reading the input as list of tuples, each containing two values
# (opponent's choice and ours choice). Then we process the list in order,
# first adding score for our selected choice and then for the determined state
# of the game (won, lost, draw).
#
